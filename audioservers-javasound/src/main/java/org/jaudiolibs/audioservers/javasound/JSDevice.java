...
class JSDevice extends Device {
    ...
    JSDevice(Mixer mixer, int maxInputChannels, int maxOutputChannels) {
        super(mixer.getMixerInfo().getName(), maxInputChannels, maxOutputChannels);
        lookup = new ObjectLookup(mixer);
    }
